...
#define GPIO_TMM_FRMLOCK	  21
#define GPIO_TMM_SPIC_XIRQ	  26
#define GPIO_TMM_SPIS_XIRQ	  27
#define GPIO_TMM_SPI_MOSI	  33
#define GPIO_TMM_SPI_MISO	  34
#define GPIO_TMM_SPI_CS 	  35
#define GPIO_TMM_SPI_CLK	  36
#define GPIO_TMM_XIRQ		  124
#define GPIO_TMM_XRESET		  126
#define GPIO_TMM_PWR_EN		  130
#endif
...
#ifdef CONFIG_ISDBTMM
#if 0
static uint32_t tmm_gpio_table[] = {
	GPIO_CFG(GPIO_TMM_FRMLOCK, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_SPIC_XIRQ, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_SPIS_XIRQ, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_SPI_MOSI, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_SPI_MISO, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_SPI_CS, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_SPI_CLK, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_XIRQ, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
	GPIO_CFG(GPIO_TMM_XRESET, GPIOMUX_FUNC_GPIO,
		GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};

static void tmm_gpio(void)
{
	int n, rc;
	printk(KERN_DEBUG "tmm_gpio\n");

	for (n = 0; n < ARRAY_SIZE(tmm_gpio_table); n++) {
		rc = gpio_tlmm_config(tmm_gpio_table[n], GPIO_CFG_ENABLE);
		if (rc)
			break;
	}
	return;
...
static struct tmm_platform_data tmm_pdata = {
	.gpio_on = tmm_gpio,
};
#endif
...
{
	printk("tmm_device tmm_dev_init start\n");
	...
	if (spi_register_board_info(tmm_spi_info, ARRAY_SIZE(tmm_spi_info))
		...
		printk("tmm_device" " tmm_dev_init err\n");
	}

	printk("tmm_device tmm_dev_init end\n");
